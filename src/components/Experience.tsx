  ...
  const experiences = [
    {
      ...
      description: "Developing enterprise healthcare, inventory, and security management systems using ASP.NET MVC, .NET Core, Angular, and SQL Server.",
      achievements: [
        "Developed MIMS using ASP.NET MVC and SQL Server, automating inventory tracking workflows and reducing manual errors",
        ...
        "Built Authentiko — a secure file, payment & transport management system with role-based auth, encrypted SFTP, and AWS S3 storage",
      ],
    },
    {
      ...
      location: "Chandigarh",
      description: "Trained in full-stack development with ASP.NET Core MVC, Entity Framework, and Angular. Built e-commerce platforms with focus on performance optimization.",
      achievements: [
        ...
        "Implemented user authentication, order management, and enhanced MVC views and controllers",
      ],
    },
  ];
